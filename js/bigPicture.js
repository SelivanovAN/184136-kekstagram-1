...
(function () {
  ...
  window.renderBigPicture = function (photo) {
    window.bigPicture.querySelector('.big-picture__img img').src = photo.url;
    window.bigPicture.querySelector('.likes-count').textContent = photo.likes;
    window.bigPicture.querySelector('.comments-count').textContent = photo.comments.length;
    window.bigPicture.querySelector('.social__caption').textContent = photo.description;
  ...
  window.renderBigPicture(window.photos[8]);
